...
class RandName
{
    ...
    public function getName()
    {
        ...
        $count1 = count($this->xing);
        $count2 = count($this->ming);
        if (rand(1,2) == 1) {
            return $this->xing[rand(0, $count1-1)].$this->ming[rand(0, $count2-1)];
        } else {
            return $this->xing[rand(0, $count1-1)].$this->ming[rand(0, $count2-1)].$this->ming[rand(0, $count2-1)];
        }
    }
}
